...
# print(sys.path)
# logging.debug("set_custom_trace")
# import sys
# import random
# import requests
# import pandas as pd
...
#         "temp_max": [random.randint(10, 30) for _ in range(len(data["daily"]["time"]))]
#     })
...
#     # df[["btc_usd", "EUR", "BRL", "temp_max"]] = df[["btc_usd", "EUR", "BRL", "temp_max"]].apply(normalize_series)
